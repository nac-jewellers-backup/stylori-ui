...
export default function ChildCollectionItemTwo(props) {
  ...
  return (
    <>
      {props.CollectionPageStylori &&
      props.CollectionPageStylori.Testimony &&
      props.CollectionPageStylori.Testimony.carousel &&
      props.CollectionPageStylori.Testimony.carousel.data &&
      props.CollectionPageStylori.Testimony.carousel.data.length > 0 ? (
        <>
          {props.CollectionPageStylori &&
            props.CollectionPageStylori.Testimony &&
            props.CollectionPageStylori.Testimony.carousel &&
            props.CollectionPageStylori.Testimony.carousel.data &&
            props.CollectionPageStylori.Testimony.carousel.data.map(
              (data, index) => (
                <>
                  {index >= 2 ? (
                    <>
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                              <Slideshow
                                ...
                                dataCarousel={
                                  props &&
                                  props.CollectionPageStylori &&
                                  props.CollectionPageStylori.carouselTop &&
                                  props.CollectionPageStylori.carouselTop
                                    .setting &&
                                  props.CollectionPageStylori.carouselTop
                                    .setting
                              ...
                              >
                                {data && data.containerImage && (
                                  <Grid container key={index}>
                                    <a href={data.containerImage.navigateUrl}>
                                      <img
                                        src={data.containerImage.img}
                                        loading="lazy"
                                        alt="...."
                                        style={{
                                          width: "100%",
                                ...
                                >
                                  ...
                                  <Grid style={{ margin: "0px 0px 10px 0px " }}>
                                    ...
                                    >
                                      <Typography
                                        component="h3"
                                        className={classes.typograpyTop}
                                      >
                                  ...
                                  <Grid container>
                                    ...
                                    >
                                      <Slideshow
                                        ...
                                        sliderRef={slider1}
                                      >
                                        {data.primaryCarouselDetails.map(
                                          (val, index) => (
                                            <>
                                              <Grid
                                                container
                                              ...
                                              >
                                                <Grid
                                                  ...
                                                  xl={6}
                                                  className={
                                                    classes.testimonialRight
                                                  }
                                                >
                                                  <Typography
                                                    className={
                                                      classes.typograpyTop
                                                    }
                                                  >
                                                    {val.imageTitle}
                                                  </Typography>
                                                ...
                                                >
                                                  ...
                                                  >
                                                    ...
                                                    <Grid
                                                      ...
                                                      onClick={() => {
                                                        window.location.pathname = `${val.navigateUrl}`;
                                                      }}
                                                    >
                                                      <a href={val.navigateUrl}>
                                                        <img
                          ...
                          <Grid container>
                            <Grid container className={classes.containerMargin}>
                              ...
                              >
                                ...
                                data.secondaryCarouselDetails.length > 0 ? (
                                  <Grid container>
                                    <Grid
                                      xs={1}
                                      sm={1}
                                    ...
                                    >
                                      ...
                                      >
                                        {data &&
                                          data.secondaryCarouselDetails &&
                                          data.secondaryCarouselDetails.map(
                                            (val, index) => (
                                              <>
                                                <Grid
                                                  container
