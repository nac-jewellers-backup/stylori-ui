...
import { Grid, Button, Hidden, Container, Typography, TextField,InputAdornment,Input } from "@material-ui/core";
       ...
       <Container style={{backgroundColor: silver ? "#06AB9F": "#fff",color: silver ? "#fff" :"#111"}}>
         <Hidden only={["sm", "xs"]}>
           ...
           >
             ...
             >
                 <Grid item xs={3}>
                   <Typography className="footerTitle">Shop by Categories</Typography>
          ...
          <Container>
            <Grid item xs={12} style={{ padding: "15px 0px 15px 0px" }}>
              ...
              <Typography style={{ fontSize: "11px", color: silver ? "#fff" :"rgb(128, 128, 128)" }}>
                ...
                Classic Bangles, Bangles, Bracelets, Silver Necklace, Bridal
                Accessories, Men's collection, Everyday Jewellery, Long
                Necklace, Short Necklace, Hair Ornaments, Choker, Odiyanam,
                anklets, oxidised jewellery, oxidised ornaments, Contemporary
                wear
              </Typography>
            </Grid>
          </Container>
