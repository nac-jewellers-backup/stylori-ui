    ...
    return (
        <Grid className={classes.root}>
            ...
            {props.isHover ?
                  ...
                  <Grid item className={classes.firstcolumn} md={9} lg={0} xl={0}>
                      <Grid container >
                          <Grid item md={12} sm={12} xs={12} className={`hovereffectSilvertoppicks`}>
                              <div>
                                  <a className={classes.imagefull} href={'earrings-jewellery'}>
                          ...
                          <Grid item md={12} sm={12} xs={12} className={`hovereffectSilvertoppicks`}>
                              <div>
                                  <a className={classes.imagefull} href={'pendants-jewellery'}>
                          ...
                          <Grid item container style={{ paddingTop: "2px" }} className={`${classes.img2container} `}>
                              <Grid item md={6} sm={6} xs={6} className={`${classes.imgsmall} hovereffectSilvertoppicks`} >
                            ...
                            <div className={"collectionDataSilverSEOflex"}>
                              <div style={{ margin: "auto" }}>
                                <h2 className="next-price" style={{fontSize:'0.6rem'}}>
                                  {"Rings".toUpperCase()}
                                </h2>
                              </div>
                            </div>
                              ...
                              <Grid item md={6} sm={6} xs={6} className={`hovereffectSilvertoppicks`}>
                  ...
                  <Grid container item className={`${classes.marginAuto} hovereffectSilvertoppicks`} md={3} p0 lg={0} xl={0}>
            ...
            <Hidden smDown>
                ...
                <Grid item className={classes.firstcolumn} md={9} lg={9} xl={9}>
                  <Grid container>
                    ...
                    <Grid item md={4} lg={4} xl={4} className={`hovereffectSilvertoppicks`}>
