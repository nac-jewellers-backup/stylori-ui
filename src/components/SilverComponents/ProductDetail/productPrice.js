    ...
    <div>
      <Grid container spacing={12} xs={12} style={{ position: "absolute" }}>
        <Grid container item xs={6}>
          <div className="css-ts7n45 e5toz5w4">
            <span style={{ color: "#fff" }} className="e195g4sk5 css-5pjie5 ekntgft2">
              {val.offerDiscount}
            </span>
            <br />
        ...
        <>
                        ...
                        <Grid container item xs={8}>
                          ...
                          <div>
                            {data[0].ProductContactNum.map((val) => (
                              <div>
                                <b
                                  style={{ alignItems: "center", display: "flex", alignContent: "center" }}
                                  className={`ships-by ${classes.normalfonts}`}
                                >
                                  <span
                                    style={{ textAlign: "center", alignItems: "center", display: "flex", alignContent: "center" }}
                                  >
                                    {" "}
                                    {val.shipby}
                                  </span>
          ...
          <Hidden smDown>
            <div className={classes.width} style={{ padding: "0px 10px  10px 10px " }}>
              <Pricing price={data[0].price} offerPrice={data[0].offerPrice} offerDiscount={val.offerDiscount}>
