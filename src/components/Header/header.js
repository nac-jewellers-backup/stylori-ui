      ...
      <div>
              ...
              <Grid container spacing={12}>
                ...
                <Grid item xs={5}>
                  <div className={`head-icons ${classes.colorMain}`} style={{ fontFamily: "fontawesome" }}>
                    <InputBase className={`search ${classes.colorMain}`} placeholder="&#xf002; Search here" />
                    {/* <NavLink to="/login"> */}
                    {/* <Button
                    ...
                    >
                      <div style={{ width: "220px", height: "45px", lineHeight: "45px", cursor: "pointer" }}>
                        <a
                          onClick={() => {
              ...
              {path === "cart" || path === "checkout" ? (
                ...
                <Grid container spacing={12}>
                  <Grid
                    item
                    xs={12}
                    className={`header-navbar-list ${classes.colorLight}`}
                    onMouseLeave={() => {
                      this.setState({ Menuopen: false, Checked: false });
                    }}
                  >
                      ...
                      <a href="" className={` ${classes.colorLight}`}><i class="fa fa-plus-circle"></i>&nbsp;Stories</a> */}
                        {menuListHeader.map((listName) => {
                          return (
                            <a
                              href={listName.url}
                              className={` ${classes.menuListCursor} ${classes.colorLight} `}
                              onMouseOverCapture={() => {
                                this.setState({
                                  Menuopen: true,
                                  Checked: true,
                            ...
                            >
                              <i class="fa fa-plus-circle"></i>&nbsp;{listName.title}
                            </a>
                          );
                        })}
                      </nav>
        ...
        <Hidden mdUp>
          <div className="header-appbar-sticky">
            <AppBar className="header-appbar-moblie" id="smallScreen">
              <Toolbar>
                <Grid item xs={2}>
          ...
          <Drawer anchor="left" open={this.state.open} className="nav-drawer">
                ...
                <>
                  <ListItem button key={row.name} className="drawer-list">
                    ...
                    {Jewellery[row.name] !== undefined ? (
                      row.name === selected ? (
                        <ExpandMore className="drawer-arrow" />
                      ) : (
                        <ExpandLess className="drawer-arrow" />
                      )
                    ) : (
                      ""
                    )}
