    ...
    return (
        <div>
            ...
            <Grid spacing={12} container lg={12} xs={12}>
                <Grid item lg={window.location.pathname !== "/cart" && window.location.pathname.split("-")[0] !== "/account" && window.location.pathname !== "/checkout" ? 2 : 6} 
                xs={window.innerWidth < 360 ? 12 : 6}>
                    {props.offerPrice ?
