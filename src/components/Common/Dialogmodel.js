...
export default function PineDialog(props) {
  ...
  return (
    ...
    >
      <Typography id="responsive-dialog-title" className={classes.titleTypo}>
        {props.title}
      </Typography>
      <Divider />
      <DialogContent>
          ...
          >
            {props.logout ? (
              ...
              <i
                class="fa fa-close"
                aria-hidden="true"
                style={{ marginRight: "7px", color: "#ffa0a0" }}
              ></i>
            )}
            {props.negativeBtn}
          </Button>
          ...
          >
            {props.logout ? (
              ...
              <i
                class="fa fa-check "
                aria-hidden="true"
                style={{ marginRight: "7px", color: "#92d049" }}
              ></i>
            )}{" "}
            {props.positiveBtn}
          </Button>
