  ...
  const handelRemove = (num) => {
    ...
    if (user_id.length > 0 && check_gustlog === "false") {
      ...
      if (!localStorageQuantity) {
        ...
        filters.quantity[values.product_sku] =
          localStorageQuantity[values.product_sku];
      }
                ...
                if (
                  ...
                  if (
                    ...
                    fetch(`${API_URL}/addtocart`, {
                      ...
                      if (
                        JSON.stringify(values.add) &&
                        JSON.stringify(values.add).length > 0 &&
                    ...
                    if (
                      values &&
                      values.product_sku &&
                      Object.values(values.product_sku).length > 0 &&
                      values.add &&
                      Object.values(values.add).length > 0
                    ) {
