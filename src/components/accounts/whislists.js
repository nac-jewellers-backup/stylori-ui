...
const Wishlists = (props) => {
  const { setCartFilters, CartCtx, setLoadingWishlist } =
  ...
  check_img = (imges) => {
    ...
    if (imges && imges.length > 0) {
      ...
      var browser_type_append =
        ...
        extension_split
          .split(".")[0]
          .concat(`${browser_type && browser_type.browser_type}`); //eslint-disable-line
                ...
                <>
                  ...
                  >
                    ...
                    <Grid
                      ...
                      onClick={() => this.props.setLoadingWishlist(true)}
                    >
                      <RemoveWishlist
                        sku={first_map?.skuId}
                        ...
                        <div className="add-bag">
                          <>
                            <RemoveWishlist
                              ...
                              data={
                                <>
                                  <i class="fa fa-shopping-bag"></i>&nbsp;Add to
                                  Bag
                                </>
                              }
                              datas={this.props.data}
