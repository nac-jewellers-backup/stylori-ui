                        ...
                        {allorderdata && allorderdata.allorderdata && allorderdata.allorderdata.nodes.length > 0 ?
                            <div style={{ marginTop: "20px", boxShadow: "none" }}>
                                ...
                                <div className="address_details">
                                    ...
                                    {/* ))} */}
                                    {/* <div style={{ float: "right", fontSize: "18px" }} >Grand Total&nbsp;<span style={{ color: '#ed1165', fontSize: "18px" }}>{this.calculatetotal(allDatas_filter())}</span></div> */}
                                    {allDatas_filter() && allDatas_filter().shoppingCartByCartId && allDatas_filter().shoppingCartByCartId.shoppingCartItemsByShoppingCartId && allDatas_filter().shoppingCartByCartId.shoppingCartItemsByShoppingCartId.nodes.map(cart => (
                                        <>
                                            <br />
                                    ...
                                    <div style={{ float: "right", fontSize: "13px", lineHeight: "1.5" }} >
                                        {/* Sub Total&nbsp;{this.calculatetotal(allDatas_filter())}<br /> */}
                                        Shipping&nbsp;FREE<br />
                                        Shipping Insurance&nbsp;FREE<br />
                                        {/* <div style={{ float: "right", fontSize: "18px" }} >Grand Total&nbsp;<span style={{ color: '#ed1165', fontSize: "18px" }}>{this.calculatetotal(allDatas_filter())}
                                            </span></div> */}
                                    </div>
                                </div>
