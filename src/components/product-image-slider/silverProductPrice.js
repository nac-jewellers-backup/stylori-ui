...
const Productprice = (props, anchorEl, handleClick, handleClose, globalContext) => {
    const { data } = props;
    const { classes } = props;
    const open = anchorEl;
                    ...
                    <Grid container spacing={12} sm={12} className={classes.pricedetails}>
                        ...
                        {/* <Paper elevation={0} style={{ width: "100%", padding: "0px", margin: "0px " }}> */}
                            <Grid container className="containbev" >
                                ...
                                <Hidden smDown>
                                <Grid item xs={12} lg={9} md={9} className={classes.width} style={{ padding:globalContext.Globalctx.pathName ? 0 : "0px 10px  0px 10px " }}>
                                <Pricing
