...
class Component extends React.Component {
    ...
    handleClickMetal = (event) => {
        console.log('metalPurity', event.target.id)
    ...
    handleClickDiamond = (event) => {
        ...
        this.setState({
            diamondClarity,
        }, () => this.props.setFilters(diamondClarity))
    }
