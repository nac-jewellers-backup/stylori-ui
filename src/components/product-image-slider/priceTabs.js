...
class Component extends React.Component {
    ...
    imageRender = (val) => {
        ...
        if (val == '18K Yellow') {
            return (
                <img src='https://img.icons8.com/color/48/000000/gold-bars.png' style={{ width: '30px', margin: "auto" }} alt="" />
            );
        } if (val == '22K Yellow') {
