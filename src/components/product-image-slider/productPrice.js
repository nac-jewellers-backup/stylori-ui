                                                ...
                                                >
                                                    <div className="product-share">
                                                        ...
                                                        <a class="facebook" target="_blank" href={`https://www.facebook.com/sharer/sharer.php?u=${window.location.href}`}>
                                                            <img class="lazyload" src="https://styloriimages.s3.ap-south-1.amazonaws.com/images/static/newsprite/iconmonstr-facebook-5-share.svg" />
                                                        </a>&nbsp;
                                            <a class="twitter" target="_blank" href={`http://www.twitter.com/share?url=${window.location.href}`}>
                                                            <img class="lazyload" src="https://styloriimages.s3.ap-south-1.amazonaws.com/images/static/newsprite/iconmonstr-twitter-5-share.svg" />
                                                        </a>&nbsp;
                                            {/* <a class="google" target="_blank">
                                                            <img class="lazyload" src="https://styloriimages.s3.ap-south-1.amazonaws.com/images/static/newsprite/iconmonstr-google-plus-5-share.svg" />
                                                        </a> */}
                                                    </div>
                                                </Popover>
