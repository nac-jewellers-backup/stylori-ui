...
const RatingComponent = (props) => {
  ...
  return isSilver ? (
    <Grid
      container
      style={{ marginTop: "10px", paddingLeft: "5%", paddingRight: "5%" }}
    >
      <Grid
        container
        item
      ...
      >
        <div
          className={`bg-clr2 ${isSilver ? "" : `priceecontainer`}`}
          style={{ width: "100%" }}
        >
          <form
            id="Resetform"
            ...
            <Grid container spacing={12}>
              ...
              <Grid item xs={12} lg={12}>
                <div className="rating-form ">
                  ...
                  {isSilver && (
                    <h5
                      className={`rating-form-head ${classes.reviewandratingsmallScreen}`}
                    >
                      {"RATE & REVIEW"}
                    </h5>
                  )}
                ...
                <div
                  style={{ width: "100%" }}
                  className={`tool-tips ${classes.normalfonts}`}
                >
                  Max 60 characters
                </div>
                <label className="errtext">
...
{/* 
                ...
                <div style={{ padding: "10px 0px" ,font:"inherit"}} className={"bigText "}>
                  <textarea
                    name="message"
                    placeholder={
                      isSilver
                ...
                {/* <Input
                    ...
                    error={values.error && values.error.ratemsg ? true : false}
                /> */}
                <div className={`tool-tips ${classes.normalfonts}`}>
                  Max 250 characters
                </div>
                <label className="errtext">
                  {" "}
              ...
              <Grid container spacing={12} style={{ marginTop: "20px" }}>
                <Grid item xs={12} lg={12}>
                  <div style={{ float: "right" }}>
                    <Button
                      className={`form-reviews-mob ${classes.fontwhite} ${
                        classes.normalcolorback
                      } ${props.isSilver ? classes.normalcolorbackSilver : ""}`}
                      type="submit"
                    >
                      Submit
                    </Button>
                    <Button
                      ...
                      className={`form-cancel-mob ${classes.normalfonts} ${
                        classes.backgwhite
                      } ${
                        props.isSilver
                          ? classes.normalcolorbackSilverCancel
                          : ""
                      }`}
                    >
                      Cancel
