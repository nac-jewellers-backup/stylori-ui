                    ...
                    <Container maxWidth="lg">
                        <Grid container spacing={2} >
                            <Grid item xs={3} spacing={2} style={{ height: "650px" }}>
                                <img height="100%" width="100%" src='https://assets-cdn.stylori.com/276x567/images/homepage/PendantVertical.png' /></Grid>
                            <Grid container item xs={9}>
                                <Grid container xs={12} spacing={2}>
                                    <Grid item xs={4}>
                                        <img height="100%" width="100%" src='https://assets-cdn.stylori.com/276x276/images/homepage/BangleSquare.png' />
                                    </Grid>
                                    <Grid item xs={8}>
                                        <img height="100%" width="100%" src='https://assets-cdn.stylori.com/1150x575/images/homepage/EarringRectangle.png' />
                                    </Grid>
                                </Grid>
                                <Grid container xs={12} spacing={2} style={{ marginTop: "6px" }}>
                                    <Grid item xs={8}>
                                        <img height="100%" width="100%" src='https://assets-cdn.stylori.com/552x276/images/homepage/RingRectangle.png' />
                                    </Grid>
                                    <Grid item xs={4}>
                                        <img height="100%" width="100%" src='https://assets-cdn.stylori.com/276x276/images/homepage/nosepinSquare.png' />
                                    </Grid>
                                </Grid>
                            </Grid>
                        </Grid>
