                                            ...
                                            <Grid container spacing={12} >
                                                <Grid xs={4} lg={4}>
                                                    <Card className="sub-scrl-card">
                                                        <img src={step.imgPath} loading="lazy" alt="...."/>
                                                    </Card>
                                                    <br />
                        ...
                        <Grid container spacing={2} >
                            ...
                            <Grid container item xs={9}>
                                <Grid container xs={12} spacing={2}>
                                    <Grid item xs={4}>
                                        <img height="100%" width="100%" src='https://assets-cdn.stylori.com/276x276/images/homepage/BangleSquare.png' loading="lazy" alt="...."/>
                                    </Grid>
                                    <Grid item xs={8}>
                                        <img height="100%" width="100%" src='https://assets-cdn.stylori.com/1150x575/images/homepage/EarringRectangle.png' loading="lazy" alt="...."/>
                                    </Grid>
                                </Grid>
                                <Grid container xs={12} spacing={2} style={{ marginTop: "6px" }}>
                                    <Grid item xs={8}>
                                        <img height="100%" width="100%" src='https://assets-cdn.stylori.com/552x276/images/homepage/RingRectangle.png' loading="lazy" alt="...."/>
                                    </Grid>
                                    <Grid item xs={4}>
                                        <img height="100%" width="100%" src='https://assets-cdn.stylori.com/276x276/images/homepage/nosepinSquare.png' loading="lazy" alt="...."/>
                                    </Grid>
                                </Grid>
                            </Grid>
                        </Grid>
