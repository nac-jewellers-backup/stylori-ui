                    ...
                    <Grid container spacing={2} >
                        <Grid container item xs={9}>
                            <Grid container xs={12} spacing={2}>
                                ...
                                <Grid item xs={8}>
                                    <img height="100%" width="100%" src='https://assets-cdn.stylori.com/552x276/images/homepage/Stylori-ring-tile.jpg'/>
                                </Grid>
                                <Grid item xs={4}>
            <img height="100%" width="100%" src='https://assets-cdn.stylori.com/276x276/images/homepage/276X276 PIXELS MANGO COLLECTIONS TILE-01 (1).jpg'/>
                                </Grid>
                            </Grid>
                            <Grid container xs={12} spacing={2} style={{marginTop:"6px"}}>
                                
                                <Grid item xs={4}>
                                    <img height="100%" width="100%" src='https://assets-cdn.stylori.com/276x276/images/homepage/-11.jpg'/>
                                </Grid>
                                <Grid item xs={8}>
                                    <img height="100%" width="100%" src='https://assets-cdn.stylori.com/552x276/images/homepage/Stylori_ Daisy Days.jpg'/>
                                </Grid>
                            </Grid>
                        </Grid>
                        <Grid item xs={3} spacing={2} style={{height:"650px"}}>
                            <img height="100%" width="100%" src='https://assets-cdn.stylori.com/276x567/images/homepage/blush 3.jpg'/></Grid>
                    </Grid>
        </Container>
            </div>
            {/* <Grid container spacing={2} >
