      ...
      {location.pathname === "/styloriSilver" ? (
            ...
            <div style={{ padding: "16px" }}>
              ...
              <p style={{ margin: "8px 0 0 0", padding: "0 4px" }}>
                ...
                >
                  ...
                  more styles, click on the link in bio. DM for enquries.
                  #Stylori #jewellery #Jewellerylover #Styles #accessories
                  #fashion #gold #goldjewellery #shopping #onlineshopping
                  #DiamondJewellery #styletip #girlsbestfriend #ringsforsale
                  #instajewellery ShopNow@https://www.stylori.com/jewellery
                </a>
              </p>{" "}
              <p
                style={{
        ...
        <>
          ...
          <blockquote
            className="instagram-media"
            data-instgrm-captioned
            data-instgrm-permalink="https://www.instagram.com/p/CCS8xMupXh8/?utm_source=ig_embed&utm_campaign=loading"
          ...
          >
            <div style={{ padding: "16px" }}>
              {" "}
              <a
                href="https://www.instagram.com/p/CCS8xMupXh8/?utm_source=ig_embed&utm_campaign=loading"
                style={{
                  background: "#FFFFFF",
                  lineHeight: 0,
                  padding: "0 0",
