...
export default function ImageGridList(props) {
  let carosolData =
    props &&
    props.carosolData &&
    props.carosolData.data &&
    props.carosolData.data.allCustomerReviews &&
    props.carosolData.data.allCustomerReviews.nodes;
              ...
              <Grid container>
                <Grid item xs={12}>
                  <Slideshow
                    ...
                    sliderRef={slider}
                  >
                    {Array.isArray(carosolData) &&
                      carosolData.map((val, index) => (
                        <>
                          <Grid container>
                            <Grid
                              item
                            ...
                            >
                              ...
                              <Grid item>
                                {val?.productListByProductId
                                  ...
                                  <img
                                    className={classes.imgcoin}
                                    src={`${CDN_URL}product/1000X1000/productnotfound.webp`}
                                    loading="lazy"
                                    alt="...."
                                  />
                                )}
                              ...
                              >
                                {val.transSkuListByProductSku.markupPrice ? (
                                  <Typography
                                    style={{
                                      color: "#394578",
                                      fontSize: "0.9rem",
                              ...
                              >
                                <a
                                  ...
                                  href={
                                    val.transSkuListByProductSku &&
                                    val.transSkuListByProductSku.skuUrl &&
                                    val.transSkuListByProductSku.skuUrl
                                  }
                                >
                                  <Button
