...
class Component extends React.Component {
    ...
    render() {
        ...
        return (
            <Paper style={{ position: 'sticky', top: "63px", width: '100%', zIndex: 11, boxShadow: 'none', borderBottom: '1px solid #e3e3e3', borderTop: '1px solid #e3e3e3', display: 'flex' }} id="filterBy">
