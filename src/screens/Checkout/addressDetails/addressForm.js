                ...
                {(isedit === '1' ? true : false) && values.addrs === true ?
                    <div className='pt-sm'>
                        <form onSubmit={(e) => {
                            ...
                            </p>  <Grid container  xs={12} lg={12} >
                                <Grid item xs={12} lg={window.location.pathname.split("-")[0] === "/account" ? 12 : 12}>
                    ...
                    : <Addressdetails open={values.open} setOpen={values.setOpen} handleClose={handle.handleClose} handleOpen={handle.handleOpen} Delete_address={handle.Delete_address} selectaddreses={handle.selectaddreses} values={values} setValues={setValues} changevalue={props.changePanel} redirectForm1={handle.redirectForm1} redirectForm={handle.redirectForm} isCheck={props?.isCheck} />}
            </div>
        </Grid>
    )
}
