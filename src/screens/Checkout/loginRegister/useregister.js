...
let namesOf_first = localStorage.getItem("namesOf_first") ? JSON.parse(localStorage.getItem("namesOf_first")) : ""
let namesOf_last = localStorage.getItem("namesOf_last") ? JSON.parse(localStorage.getItem("namesOf_last")) : ""
